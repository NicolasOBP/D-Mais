/** biome-ignore-all lint/suspicious/noExplicitAny: <intended behavior> */
import { create } from "zustand"

import type { ModalFooterProps } from "./components/ModalFooter"
...
export function useModalStoreZustand(): Pick<ModalStoreType, "modal" | "modalData"> {
...
export function useModalServiceZustand(): Omit<ModalStoreType, "modal" | "modalData"> {
