...
export function EyeIcon({ toggleIsSecure, opacityValue, iconSize = 23 }: Props) {
	...
	return (
		<Box width={iconSize} height={iconSize}>
			<Animated.View style={eyeOffStyle}>
				<Icon onPress={toggleIsSecure} name="eyeOff" color="gray2" size={iconSize} />
			</Animated.View>

			<Animated.View style={eyeOnStyle}>
				<Icon onPress={toggleIsSecure} name="eyeOn" color="gray2" size={iconSize} />
			</Animated.View>
		</Box>
	)
}
