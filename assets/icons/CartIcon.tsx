...
export function CartIcon({ size = 20, color = "black" }: IconBase) {
	return (
		<Svg width={size} height={size} viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet">
          ...
          4 -1328 6 0 6 118 331 134 369 l15 37 1256 0 c1239 0 1256 0 1295 20 26 13 47
          34 60 60 29 57 710 2185 710 2218 0 51 -41 115 -90 140 -44 22 -66 24 -1660
          92 l-1615 69 -45 -22 c-60 -29 -90 -76 -90 -139 0 -27 7 -62 15 -77 20 -40 70
          -79 108 -86 18 -3 695 -35 1505 -70 811 -35 1476 -65 1478 -68 3 -3 -125 -409
          -283 -903 l-288 -899 -1297 -3 -1296 -2 -5 22 c-3 13 -110 590 -237 1283 -146
          794 -237 1271 -248 1289 -9 16 -29 38 -43 48 -37 28 -807 330 -854 335 -29 3
          -53 -2 -85 -19z m1938 -4104 c147 -61 178 -257 57 -362 -47 -42 -77 -53 -141
